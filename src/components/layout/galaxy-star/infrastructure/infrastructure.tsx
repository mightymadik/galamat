...
export default function Infrastructure() {
  ...
  const russianTexts = {
    ...
    alley: "Аллея в шаговой доступности",
    ...
    architectureDescription:
      "Тёплая кирпичная фактура домов Galaxy Star создаёт ощущение надёжности и уюта с первого взгляда. Фасады выполнены в современном вентфасаде из стальной композитной панели — материал, который сочетает прочность, долговечность и выразительную эстетику. Контрастные оттенки панелей придают зданиям динамику и подчёркивают космическую концепцию проекта.",
    ...
    facade: "Фасад",
    facadeDesc: "Долговечный вентилируемый фасад, стальная композитная панель",
  };
  ...
  const kazakhTexts = {
    ...
    alley: "Тұрғын үй кешені қасында жайлы аллея орналасқан",
    courtyardTitle: "Ішкі аула",
    courtyardSubtitle: "Қауіпсіздік",
    courtyardDescription:
      "Galaxy Star ауласындағы өмір атмосферасын сезініңіз. Үлкен футбол алаңында эмоциялар қайнап жатыр, заманауи ойын алаңында әр жастағы балалар ойнап жүр, аллея бойымен веложолдар өтеді, ал демалыс аймағында тұрғындар жайлы орындықтарда уақыт өткізеді. Жанында — кең воркаут-аймағы және кітап оқуға немесе тыныш әңгімеге арналған жасыл тыныш аймақтар бар. Galaxy Star ауласында әр адам өзіне лайық кеңістікті табады — динамикалық, жайлы және шабыттандыратын.",
