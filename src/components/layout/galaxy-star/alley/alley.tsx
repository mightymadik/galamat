...
export default function Alley() {
  ...
  const russianTexts = {
    ...
    alley: "Парк — в двух шагах",
    description: `Прямо у ЖК Galaxy Star расположена уютная зелёная парк — большое преимущество для жителей комплекса.
...
Это пространство становится продолжением вашего двора — местом, где можно проводить время каждый день, не уезжая далеко от дома.`,
    ...
    ownAlley: "Собственная Парк",
    ownAlleyDesc:
      "Рядом с ЖК Galaxy Star проходит уютная зелёная парк — одно из ключевых преимуществ для жителей",
...
Бұл кеңістік сіздің ауылыңыздың жалғасуы болып табылады - үйден алыс жүрмей, күн сайын уақыт өткізуге болатын орын.`,
    ...
    internetDesc:
      "Саябақтағы тегін Starlink интернеті - әрбір тұрғынның ыңғайлылығы үшін.",
    ownAlley: "Меншікті Саябақ",
    ownAlleyDesc:
      "Galaxy Star ЖК-нің қасында жайлы жасыл саябақ өтеді - бұл тұрғындар үшін негізгі артықшылықтардың бірі",
    ...
    chargingDesc:
      "Саябақта электромобильдерге арналған Edrive зарядтық станциялары орнатылған - барлық тұрғындарға қолжетімді",
