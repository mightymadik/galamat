...
export default function PreloadComponent() {
    ...
    return (
        <div
            className={`w-full h-[100dvh] flex justify-center items-center bg-white fixed top-0 left-0 px-[100px] z-[999] transition-opacity duration-500 ${isVisible ? "opacity-100" : "opacity-0 pointer-events-none"
                }`}
        >
            <svg
