...
export default function Menu() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="transition-all duration-300">
                    <path d="M8 6V4.75C8 4.05964 8.55964 3.5 9.25 3.5H14.75C15.4404 3.5 16 4.05964 16 4.75V6" stroke="#1A3C7E" strokeWidth="1.5" strokeLinecap="round" />
                    <path d="M4.5 8.5C4.5 7.67157 5.17157 7 6 7H18C18.8284 7 19.5 7.67157 19.5 8.5V16.5C19.5 17.3284 18.8284 18 18 18H6C5.17157 18 4.5 17.3284 4.5 16.5V8.5Z" stroke="#1A3C7E" strokeWidth="1.5" />
                    <path d="M4.5 11.5H19.5" stroke="#1A3C7E" strokeWidth="1.5" />
                    <path d="M10.5 13.5H13.5V15.5H10.5V13.5Z" stroke="#1A3C7E" strokeWidth="1.5" />
                </svg>
            ),
            link: ("/career")
        },
