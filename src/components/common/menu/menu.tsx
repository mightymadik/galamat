...
export default function Menu() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="transition-all duration-300">
                    <path fillRule="evenodd" clipRule="evenodd" d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12ZM12 8.625C11.4403 8.625 10.9863 9.07899 10.9863 9.63867C10.9863 10.0117 10.684 10.314 10.311 10.314C9.93801 10.314 9.63574 10.0117 9.63574 9.63867C9.63574 8.33262 10.6939 7.27441 12 7.27441C13.3061 7.27441 14.3643 8.33262 14.3643 9.63867C14.3643 10.2787 14.1091 10.8606 13.6963 11.2852C13.6132 11.3707 13.534 11.4499 13.4585 11.5254C13.2642 11.7195 13.0939 11.8897 12.9446 12.0815C12.7474 12.335 12.6764 12.5213 12.6768 12.6777V13.3535C12.6768 13.7265 12.3745 14.0288 12.0015 14.0288C11.6284 14.0288 11.3262 13.7265 11.3262 13.3535V12.6777C11.3262 12.0878 11.6008 11.6104 11.8794 11.2524C12.0855 10.9877 12.3446 10.7292 12.5549 10.5195C12.6184 10.4562 12.6774 10.3973 12.729 10.3442C12.9066 10.1614 13.0142 9.91389 13.0137 9.63867C13.0137 9.07899 12.5597 8.625 12 8.625ZM12 16.5C12.4971 16.5 12.8999 16.0971 12.8999 15.6001C12.8999 15.103 12.4971 14.7002 12 14.7002C11.5029 14.7002 11.1001 15.103 11.1001 15.6001C11.1001 16.0971 11.5029 16.5 12 16.5Z" fill="#1A3C7E" />
                </svg>
            ),
            link: ("/why-us")
        },
        ...
        >
            ...
            >
                ...
                <div className="drawerMenu flex !p-4 flex-col items-start">
                    ...
                    <Link onClick={() => setIsDrawerOpen(false)} className="drawerMenuButton flex h-10 items-center self-stretch justify-between p-![0px]" href="/career">
                        <div className="drawerMenuButtonLogoAndTitle flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M5.33334 4V3.16667C5.33334 2.61438 5.78105 2.16667 6.33334 2.16667H9.66667C10.219 2.16667 10.6667 2.61438 10.6667 3.16667V4" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round" />
                                <rect x="3" y="4.66675" width="10" height="8.66667" rx="1.33333" stroke="#1C274C" strokeWidth="1.5" />
                                <path d="M3 7.33325H13" stroke="#1C274C" strokeWidth="1.5" />
                            </svg>
                            <p>Карьера</p>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
