...
export default function About() {
  ...
  const russianTexts = {
    ...
    mallText: "Собственная аллея, всего в двух шагах от ЖК ",
  ...
  const kazakhTexts = {
    ...
    mallText: "Тұрғын үй кешені екі қадам жерде жеке меншік аллея орналасқан ",
    ...
    transportText:
      "Аллеяда электромобильдерге арналған қуаттау станциялары және тегін Starlink интернеті орнатылған ",
    facilitiesText:
