            ...
            <div ref={pdfRef} className="pdf-safe-root fixed left-0 top-0 -z-10 opacity-0 pointer-events-none" style={{ width: 794, background: "white" }}>
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-row w-full">
                        <div className="flex w-full border-r border-black/10 p-4">
                            <div className="w-full h-[360px] flex items-center justify-center">
                                {flat.images?.[0] ? (
                                    ...
                                    <div className="w-full h-full flex items-center justify-center bg-black/5 rounded-lg text-black/40 text-sm">Планировка не загружена</div>
                                )}
                            </div>
                        </div>
                        <div className="flex flex-col gap-4 boderd-l w-full border-black/10 px-12 py-12">
                    ...
                    <div className="flex items-start gap-4 border-t border-black/10 p-6">
                        {flat.images?.[1] && (
                            <div className="flex items-center justify-center flex-col gap-2 w-full">
                                <span className="text-black text-base font-normal leading-6">Этаж</span>
                                <img src={flat.images[1]} alt="План этажа" className="w-full h-full object-contain" crossOrigin="anonymous" />
                            </div>
                        )}
                        {flat.complexGenPlanImage && (
                            <div className="flex items-center justify-center flex-col gap-2 w-full">
                                <span className="text-black text-base font-normal leading-6">Генплан</span>
                                <img src={flat.complexGenPlanImage} alt="Генплан" className="w-full h-full rounded-[32px]" crossOrigin="anonymous" />
                            </div>
                        )}
                    </div>
                </div>
