...
export default function WelcomeModal({
  ...
  return (
    <Modal
      ...
      classNames={{
        base:
          "rounded-[32px] border-0 bg-transparent shadow-none max-w-[90vw] overflow-hidden",
        wrapper: "bg-black/50",
        body: "p-0",
      }}
    >
        ...
        <div className="relative flex flex-col rounded-[32px] overflow-hidden bg-[#B31623]">
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start gap-6 h-full">
              ...
              <Button
                onPress={onClose}
                aria-label={t("queue_welcome_close")}
