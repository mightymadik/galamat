...
export default function OtherProjectsClient({
    otherProjectData,
}: {
    otherProjectData: ProjectDetail[];
}) {
    const t = useTranslations();
    const [activeIndexes, setActiveIndexes] = useState<number[]>(
        otherProjectData.map(() => 0)
    );
