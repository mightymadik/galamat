...
export default function QueueBreakPanel() {
  return (
    <div className="flex w-full pl-[24px] pr-[24px] py-[32px] flex-col items-start gap-[32px] flex-[1_0_0]">
      <div className="flex flex-col w-full pt-[24px] pr-[32px] pb-[32px] pl-[24px] items-center gap-[24px] self-stretch rounded-[24px] bg-[#FFF]">
        ...
        <div className="flex w-full h-[100px] items-start gap-[16px] self-stretch">
          <div className="flex p-[12px] flex-col justify-between items-start flex-[1_0_0] self-stretch rounded-[12px] bg-[#F3F5F8]">
            <div className="flex items-center gap-[8px] self-stretch">
              ...
              <p className="text-[#282D3C] text-[12px] not-italic font-medium leading-[16px] opacity-80">Время перерыва</p>
            </div>
