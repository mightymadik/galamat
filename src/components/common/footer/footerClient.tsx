    ...
    return (
        <footer className="w-full hidden lg:flex flex-col items-start mt-auto bg-gray-100">
            <div className="wrapper flex justify-between xl:justify-end items-start self-stretch p-4">
                ...
                {/* Правая часть */}
                <div className="flex flex-col flex-1 justify-end gap-12">
                    <div className="flex flex-row gap-8 justify-end">
                        <Image src={"/img/holding.svg"} alt="logo" width={100} height={100} />
                        <Image src={"/img/galahub.svg"} alt="logo" width={100} height={100} />
                        <Image src={"/img/hub.svg"} alt="logo" width={100} height={100} />
                    </div>
